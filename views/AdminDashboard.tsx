      ...
      <div className="flex p-1 space-x-1 bg-gray-100/80 dark:bg-gray-800 rounded-xl overflow-hidden">
        <button
          ...
          className={`flex-1 px-4 py-2.5 text-sm font-medium rounded-lg transition-all shadow-sm ${
            activeTab === 'users' ? 'bg-white dark:bg-gray-700 text-indigo-600 dark:text-indigo-400 shadow-md' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 shadow-none'
          }`}
        >
        ...
        <button
          ...
          className={`flex-1 px-4 py-2.5 text-sm font-medium rounded-lg transition-all shadow-sm ${
            activeTab === 'reports' ? 'bg-white dark:bg-gray-700 text-indigo-600 dark:text-indigo-400 shadow-md' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 shadow-none'
          }`}
        >
          <div className="flex items-center justify-center">
        ...
        <button
          ...
          className={`flex-1 px-4 py-2.5 text-sm font-medium rounded-lg transition-all shadow-sm ${
            activeTab === 'settings' ? 'bg-white dark:bg-gray-700 text-indigo-600 dark:text-indigo-400 shadow-md' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 shadow-none'
          }`}
        >
          <div className="flex items-center justify-center">
                 ...
                 <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-2xl p-6 text-white shadow-lg subtle-shimmer">
                     ...
                     <div className="mb-2">
                         ...
                         {settings.systemNotification ? (
                             <div className={`p-3 rounded-xl text-white text-xs font-bold animate-fade-in flex items-start ${
                                 settings.notificationType === 'critical' ? 'bg-red-500 shadow-lg shadow-red-500/20' : 
