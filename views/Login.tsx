...
export const Login: React.FC<LoginProps> = ({ onLogin }) => {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const newUser: User & { password?: string, gender?: string, branch?: string } = {
                id: generatedId,
                name: regName.trim(),
                email: regEmail.trim(),
                        ...
                        {!isForgotPassword && !isRegistering ? (
                                ...
                                {view === UserRole.STUDENT && (
                                    <div className="text-center pt-4 border-t border-gray-100 dark:border-gray-800">
                                        <p className="text-gray-500 dark:text-gray-400 text-sm">
                                            New Student? <button type="button" onClick={() => setIsRegistering(true)} className="text-indigo-600 dark:text-indigo-400 font-bold hover:underline hover:text-indigo-700 transition-colors">Create Account</button>
                                        </p>
                                    </div>
                                )}
                            </div>
                            ...
                            <form onSubmit={handleRegister} className="space-y-5 animate-fade-in">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase ml-1">Branch Name</label>
                                        <div className="input-animated-border">
                                            <input
                                                type="text"
                                                required
